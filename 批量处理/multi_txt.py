...
def read_file_cut():  # Read file and cut
    path = r"C:\Users\12158\VSCode\py_jieba\批量处理\待处理"  # create path
    respath = r"C:\users\12158\VSCode\py_jieba\批量处理\已处理"
    file = open('批量处理/hit_stopwords.txt', 'r', encoding='UTF-8')  # 导入停用词
