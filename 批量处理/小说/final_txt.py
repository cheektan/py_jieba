...
# jieba.enable_paddle()
jieba.load_userdict("TXT/dict.txt")  # 导入自定义词典
jieba.add_word('热运动')  # 添加关键词汇


def read_file_cut():  # Read file and cut
    path = r"C:\Users\12158\VSCode\py_jieba\批量处理\小说"  # create path
    # respath = r"C:\users\12158\Downloads\py_jieba\批量处理\小说"
    file = open('TXT/hit_stopwords.txt', 'r', encoding='UTF-8')  # 导入停用词
